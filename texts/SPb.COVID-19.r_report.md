...
Данные обновлены на **2021-09-04 11:00:00**. Согласно официальным
данным, суммарное число зарегистрированных случаев по Петербургу c
момента начала эпидемии составило **581916**. Прирост за сутки –
**1494**. Прирост связанных с COVID смертей за сутки: **35**, всего с
начала эпидемии в оперативных сводках зарегистрировано смертей:
**20727**.

### Динамика эпидемического процесса

За последние семь дней (2021-07-27 — 2021-08-02):

-   выявлено **7953** новых случаев COVID-19, что составляет **96.29%**
    от числа случаев, выявленных за предшествующие семь дней (**8259**,
    2021-07-20 — 2021-07-26).

-   госпитализировано c COVID-19 **1511**, что составляет **99.28%** от
    числа госпитализированных за предшествующие семь дней (**1522**).

-   в оперативном учете зарегистрировано **248** смертей, связанных с
    COVID-19, что составляет **98.02%** от числа смертей за
    предшествующие семь дней (**253**).

Волна идет на спад. Скорость изменений критически замедлилась, возможно,
вскоре направление тренда сменится на противоположное.
...
линией.](../plots/SPb.COVID-19.PCR_tests.mini.png "Петербург: число PCR-тестов на SarsCoV-2 по дням. Семидневное скользящее среднее обзначено темно-синей линией.")
<figcaption>
...
волн и сдвиг начала третьей волны по времени почти на месяц. Подробнее
см. в отдельном документе [Критический анализ показателей эпидемической
статистики](SPb.COVID-19.data_critique.md)<br /><br />
</figcaption>
<hr />
...
путем.](../plots/SPb.COVID-19.hospitalized_today.mini.png "Петербург: число госпитализаций с COVID-19 по дням. Cемидневное скользящее среднее обозначено темно-зеленой линией. Данные за 3 июня --- 2 августа 2021 гг. официально не публиковались. Данные за 21 июня --- 27 июля 2021 г. получены неофициальным путем.")
<figcaption>
...
линией.](../plots/SPb.COVID-19.deaths.mini.png "Петербург: число смертей, связанных с COVID-19, по дням. Семидневное скользящее среднее обозначено ярко-красной линией.")
<figcaption>
<br />**Петербург: число смертей, связанных с COVID-19, по дням.**
Семидневное скользящее среднее обозначено ярко-красной
линией.<br /><br />
</figcaption>
<!--![Петербург: динамика эпидномеров](../plots/SPb.COVID-19.EN.png "Петербург: динамика эпидномеров")

Общая картина роста эпидемии по данным об эпид. номерах, предоставленных гражданами.-->
<hr />
![Петербург: количество смертей по неделям и поисковые запросы
...
связанные с сатурацией (мониторинг состояния во время болезни). По
динамике запросов можно заметить изменения в ходе эпидпроцесса раньше,
чем по другим
показателям.](../plots/SPb.COVID-19.Yandex_vs_deaths.mini.png "Петербург: количество смертей по неделям и поисковые запросы Яндекса.* Динамика запросов несколько опережает динамику смертности. Запросы, связанные с обонянием (ранний симптом), опережают вопросы, связанные с сатурацией (мониторинг состояния во время болезни). По динамике запросов можно заметить изменения в ходе эпидпроцесса раньше, чем по другим показателям.")
<figcaption>
...
-->
<!--![Петербург: обзорный график эпидемических показателей в Y-линейном масштабе](../plots/SPb.COVID-19.overview.Y_linear.png "Петербург: обзорный график эпидемических показателей в Y-линейном масштабе")-->
<!--![Петербург: обзорный график эпидемических показателей в Y-логарифмическом масштабе](../plots/SPb.COVID-19.overview.Y_log10.mini.png "Петербург: обзорный график эпидемических показателей в Y-логарифмическом масштабе")

Обзорный график эпидемических показателей в линейном и логарифмическом масштабах. Обратите внимание на неестественное поведение расчетного показателя "количество активных случаев". Оно связано с тем, что данные по зарегистрированным случаям фальсифицированы полностью, а данные по выздоровевшим -- частично.
-->
<!--![Петербург: прогноз развития эпидемии по эпидномерам](../plots/08.COVID.2019.SPb.EN.SPb_waves.approx.step_03.png "Петербург: прогноз развития эпидемии по эпидномерам")

Прогноз развития эпидемии на основании данных об эпидномерах. Вертикальная прерывистая красная линия показывает расчетную точку перегиба третьей волны, горизонтальные прерывистые красные линии -- "пол" и "потолок" третьей волны, S-образная кривая -- результат аппроксимации (приближения) "сырых" данных гладкой функцией, черные точки -- эпидномера ("сырые" данные).-->
<hr />
