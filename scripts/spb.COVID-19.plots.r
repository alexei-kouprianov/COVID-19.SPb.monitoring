...
system("convert -resize 75% ../plots/SPb.COVID-19.PCR_tests.png ../plots/SPb.COVID-19.PCR_tests.mini.png")
system("convert -resize 75% ../plots/SPb.COVID-19.confirmed.png ../plots/SPb.COVID-19.confirmed.mini.png")
system("convert -resize 75% ../plots/SPb.COVID-19.hospitalized_today.png ../plots/SPb.COVID-19.hospitalized_today.mini.png")
system("convert -resize 75% ../plots/SPb.COVID-19.deaths.png ../plots/SPb.COVID-19.deaths.mini.png")
system("convert -resize 75% ../plots/SPb.COVID-19.Yandex_vs_deaths.png ../plots/SPb.COVID-19.Yandex_vs_deaths.mini.png")
