...
open(RECOVERED, '>>../downloads/gov.spb.ru.covid-19.extracted.RECOVERED.txt') or die $!;
	while(<SRC022>){
		if($_ =~ m/\<b\>(\d+)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xb2\xd1\x8b\xd0\xb7\xd0\xb4\xd0\xbe\xd1\x80\xd0\xbe\xd0\xb2/){
		print RECOVERED $1, "\n";
		}
		else{
		print RECOVERED "NA\n";
...
open(DEATHS, '>>../downloads/gov.spb.ru.covid-19.extracted.DEATHS.txt') or die $!;
	while(<SRC023>){
		if($_ =~ m/\<b\>(\d+)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd1\x83\xd0\xbc\xd0\xb5\xd1\x80\xd0\xbb\xd0\xbe/){
		print DEATHS $1, "\n";
		}
		else{
		print DEATHS "NA\n";
...
open(HOSPITALS, '>>../downloads/gov.spb.ru.covid-19.extracted.HOSPITALS.txt') or die $!;
	while(<SRC026>){
		if($_ =~ m/\<b\>(\d+)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;\"\>\xd1\x81\xd1\x82\xd0\xb0\xd1\x86\xd0\xb8\xd0\xbe\xd0\xbd\xd0\xb0/){
		print HOSPITALS $1, "\n";
		}
		else{
		print HOSPITALS "NA\n";
...
open(BEDS, '>>../downloads/gov.spb.ru.covid-19.extracted.BEDS.txt') or die $!;
	while(<SRC027>){
		if($_ =~ m/\<b\>(\d+)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xba\xd0\xbe\xd0\xb5\xd0\xba/){
		print BEDS $1, "\n";
		}
		else{
		print BEDS "NA\n";
...
open(FREEBEDS, '>>../downloads/gov.spb.ru.covid-19.extracted.FREEBEDS.txt') or die $!;
	while(<SRC028>){
		if($_ =~ m/\<b\>(\d+),(\d+)\%\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd1\x81\xd0\xb2\xd0\xbe\xd0\xb1\xd0\xbe\xd0\xb4\xd0\xbd\xd1\x8b/){
		print FREEBEDS $1, '.', $2, "\n";
		}
		else{
		print FREEBEDS "NA\n";
...
open(HOSPITALIZED, '>>../downloads/gov.spb.ru.covid-19.extracted.HOSPITALIZED.txt') or die $!;
	while(<SRC029>){
		if($_ =~ m/\<b\>(\d+)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xbd\xd0\xb0\x20\xd0\xbb\xd0\xb5\xd1\x87\xd0\xb5\xd0\xbd\xd0\xb8\xd0\xb8\x20\xd0\xb2\x20\xd1\x81\xd1\x82\xd0\xb0\xd1\x86\xd0\xb8\xd0\xbe\xd0\xbd\xd0\xb0\xd1\x80\xd0\xb0\xd1\x85/){
...
open(AMB, '>>../downloads/gov.spb.ru.covid-19.extracted.AMB.txt') or die $!;
	while(<SRC036>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xbd\xd0\xb0 \xd0\xb0\xd0\xbc\xd0\xb1\xd1\x83\xd0\xbb\xd0\xb0\xd1\x82\xd0\xbe\xd1\x80\xd0\xbd\xd0\xbe\xd0\xbc/){
		print AMB $1, "\n";
		}
		else{
		print AMB "NA\n";
...
open(OBSERV, '>>../downloads/gov.spb.ru.covid-19.extracted.OBSERV.txt') or die $!;
	while(<SRC037>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xb2 \xd0\xbe\xd0\xb1\xd1\x81\xd0\xb5\xd1\x80\xd0\xb2\xd0\xb0\xd1\x86\xd0\xb8\xd0\xb8/){
		print OBSERV $1, "\n";
		}
		else{
		print OBSERV "NA\n";
...
open(QUARANTINE, '>>../downloads/gov.spb.ru.covid-19.extracted.QUARANTINE.txt') or die $!;
	while(<SRC038>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xbd\xd0\xb0 \xd0\xba\xd0\xb0\xd1\x80\xd0\xb0\xd0\xbd\xd1\x82\xd0\xb8\xd0\xbd\xd0\xb5/){
		print QUARANTINE $1, "\n";
		}
		else{
		print QUARANTINE "NA\n";
...
open(VSTATIONS, '>>../downloads/gov.spb.ru.covid-19.extracted.VSTATIONS.txt') or die $!;
	while(<SRC039>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;\"\>\xd0\xbf\xd1\x83\xd0\xbd\xd0\xba\xd1\x82\xd0\xbe\xd0\xb2 \xd0\xb2/){
		print VSTATIONS $1, "\n";
		}
		else{
		print VSTATIONS "NA\n";
...
open(V1CS, '>>../downloads/gov.spb.ru.covid-19.extracted.V1CS.txt') or die $!;
	while(<SRC040>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xbf\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb8\xd1\x82\xd0\xbe/){
		print V1CS $1, "\n";
		}
		else{
		print V1CS "NA\n";
...
open(V1TODAY, '>>../downloads/gov.spb.ru.covid-19.extracted.V1TODAY.txt') or die $!;
	while(<SRC041>){
		if($_ =~ m/\xd0\xbf\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb8\xd1\x82\xd0\xbe.*?\>\xd0\xb7\xd0\xb0 \xd1\x81\xd1\x83\xd1\x82\xd0\xba\xd0\xb8\: (\d+?)\</){
		print V1TODAY $1, "\n";
		}
		else{
		print V1TODAY "NA\n";
...
open(V12CS, '>>../downloads/gov.spb.ru.covid-19.extracted.V12CS.txt') or die $!;
	while(<SRC042>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xbf\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb8\xd1\x82\xd1\x8b \xd0\xb2\xd1\x82\xd0\xbe\xd1\x80\xd1\x8b\xd0\xbc/){
		print V12CS $1, "\n";
		}
		else{
		print V12CS "NA\n";
...
open(V12TODAY, '>>../downloads/gov.spb.ru.covid-19.extracted.V12TODAY.txt') or die $!;
	while(<SRC043>){
		if($_ =~ m/\xd0\xbf\xd1\x80\xd0\xb8\xd0\xb2\xd0\xb8\xd1\x82\xd1\x8b \xd0\xb2\xd1\x82\xd0\xbe\xd1\x80\xd1\x8b\xd0\xbc.*?\>\xd0\xb7\xd0\xb0 \xd1\x81\xd1\x83\xd1\x82\xd0\xba\xd0\xb8\: (\d+?)\</){
		print V12TODAY $1, "\n";
		}
		else{
		print V12TODAY "NA\n";
...
open(VREMAINING, '>>../downloads/gov.spb.ru.covid-19.extracted.VREMAINING.txt') or die $!;
	while(<SRC046>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xb4\xd0\xbe\xd0\xb7/){
		print VREMAINING $1, "\n";
		}
		else{
		print VREMAINING "NA\n";
...
open(PCRLABS, '>>../downloads/gov.spb.ru.covid-19.extracted.PCRLABS.txt') or die $!;
	while(<SRC047>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xbb\xd0\xb0\xd0\xb1\xd0\xbe\xd1\x80\xd0\xb0\xd1\x82\xd0\xbe\xd1\x80\xd0\xb8\xd0\xb9/){
		print PCRLABS $1, "\n";
		}
		else{
		print PCRLABS "NA\n";
...
open(PCRPOINTS, '>>../downloads/gov.spb.ru.covid-19.extracted.PCRPOINTS.txt') or die $!;
	while(<SRC048>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd0\xbf\xd1\x83\xd0\xbd\xd0\xba\xd1\x82\xd0\xbe\xd0\xb2 \xd0\xb7/){
		print PCRPOINTS $1, "\n";
		}
		else{
		print PCRPOINTS "NA\n";
...
open(PCRTESTS, '>>../downloads/gov.spb.ru.covid-19.extracted.PCRTESTS.txt') or die $!;
	while(<SRC049>){
		if($_ =~ m/\<b\>(\d+?)\<\/b\>\<\/span\> \<span style\=\"font\-size\: 18px\;  padding\-top\: 16px\;\"\>\xd1\x82\xd0\xb5\xd1\x81\xd1\x82/){
		print PCRTESTS $1, "\n";
		}
		else{
		print PCRTESTS "NA\n";
